...
void linshrink_cov(mat &X, arma::mat &S, const int& n, const int& p) {
...
void impute_advance(const arma::vec &beta, mat& X, const arma::vec &Y, const mat& S, const double& sigma_sq,
...
// [[Rcpp::export]]
List SLOBE_ADMM_approx_missing(NumericVector start, arma::mat Xmis, NumericMatrix Xinit, arma::vec Y, double a_prior, double b_prior, arma::mat Covmat, double sigma = 1.0,
