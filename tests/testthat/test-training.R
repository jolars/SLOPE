...
test_that("trainSLOPE works properly for binomial family", {
  ...
  expect_equal(fit$optima, structure(list(q = c(0.1, 0.2, 0.2, 0.1, 0.2),
                                          alpha = c(0.0407419692328029, 0.00951618922300669, 7.46792437250563e-05, 0.00586052810915447, 0.00951618922300669),
                                          measure = c("auc", "deviance", "mae", "misclass", "mse"),
                                          mean = c(0.660558191808191, 0.980242385609924, 0.505235518555197, 0.235, 0.323146578274459),
                                          se = c(0.0427697302697303, 0.0895079144973799, 0.0118619318307461, 0.055, 0.0303254834380574),
                                          lo = c(0.11711724249003, -0.157063501501803, 0.35451538414719, -0.463841260489608, -0.0621752230129728),
                                          hi = c(1.20399914112635, 2.11754827272165, 0.655955652963204, 0.933841260489608, 0.70846837956189)),
...
test_that("trainSLOPE works properly for multinomial family", {
  ...
  expect_equal(fit$measure$label, c("Mean Squared Error", "Mean Absolute Error",
                                    "Multinomial Deviance", "Misclassification Rate"))

  expect_equal(fit$optima, structure(list(q = c(0.2, 0.2, 0.2, 0.2),
                                          alpha = c(0.0232836583559346, 6.93003501141371e-05, 0.000481771041719308, 0.0143391993455749),
