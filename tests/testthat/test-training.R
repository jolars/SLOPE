...
test_that("trainSLOPE works properly for binomial family", {
  ...
  expect_equal(fit$optima, structure(list(q = c(0.1, 0.2, 0.2, 0.1, 0.2),
                                          alpha = c(0.0407419692328029, 0.0095161892230067, 7.46792437250563e-05, 0.00586052810915448, 0.0095161892230067),
                                          measure = c("auc", "deviance", "mae", "misclass", "mse"),
                                          mean = c(0.660558191808191, 0.980242385828498, 0.505232740237056, 0.235, 0.323146578355248),
