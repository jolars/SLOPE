...
vignette: >
  %\VignetteIndexEntry{prox-solvers}
...
\[
  \operatorname{prox}_J (v) = 
    \operatorname*{arg\,min}_x\left( J(x; \lambda) + \frac 1 2 \lVert x - v \rVert_2^2 \right)
\]
...
There are several methods for solving this proximal operator and here
...
reference for others who are interested in working with SLOPE and particularly
those who might be interested in improving the performance of these 
algorithms.
