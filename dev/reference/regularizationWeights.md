...
[`SLOPE()`](https://jolars.github.io/SLOPE/dev/reference/SLOPE.md) (or
elsewhere).
...
Please see
[`SLOPE()`](https://jolars.github.io/SLOPE/dev/reference/SLOPE.md) for
...
[`SLOPE()`](https://jolars.github.io/SLOPE/dev/reference/SLOPE.md). In
this function, no such scaling is attempted.
