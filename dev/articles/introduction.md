...
[`SLOPE()`](https://jolars.github.io/SLOPE/dev/reference/SLOPE.md).) The
main function of the package is
[`SLOPE()`](https://jolars.github.io/SLOPE/dev/reference/SLOPE.md),
which, more or less, serves as an interface for code written in C++.
There are many arguments in the function and most of them relate to
either the construction of the regularization path or the penalty
($`\lambda`$) sequence used. Here we will use the option
`lambda = "bh"`, which used the BH method detailed in Bogdan et al.
(2015) to select the sequence. (Note that it is also possible to
manually insert a sequence.)
...
#> 1 0.2 0.001638533     mae  3.613619 0.1319654  3.315093  3.912146
#> 2 0.2 0.002377231     mse 19.535859 1.1235777 16.994149 22.077568
```
